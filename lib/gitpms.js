...
var Commands = {
    'CloneGitHub':              "git clone https://{username}:{password}@github.com/{feed}.git",
...
function clone( baseReposDir, server, username, password, feed ){
    // File are placed in: /reposDir/username/server/feed
    var repoDir = path.join( baseReposDir, username, server, feed );
